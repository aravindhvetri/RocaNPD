...
export const ROUTE_DEFINITIONS: IRouteDefinition[] = [
  ...
  { path: "/admin/plant", title: "Plant Master", description: "Manage plant master records." },
  { path: "/admin/role", title: "Role", description: "Manage application roles." },
  { path: "/admin/approver-config", title: "Approver Configuration", description: "Configure approvers by role and brand." },
